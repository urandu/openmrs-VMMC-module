...
package org.openmrs.module.bootcampaddon.report.dataset.definition.evaluator;

import org.openmrs.annotation.Handler;
import org.openmrs.api.context.Context;
import org.openmrs.module.bootcampaddon.report.dataset.definition.VmmcMergingDataSetDefinition;
 ...
 */
@Handler(supports = VmmcMergingDataSetDefinition.class)
public class VmmcMergingDataSetEvaluator implements DataSetEvaluator {
	...
	public MapDataSet evaluate(DataSetDefinition dataSetDefinition, EvaluationContext context) throws EvaluationException {
		VmmcMergingDataSetDefinition dsd = (VmmcMergingDataSetDefinition) dataSetDefinition;
	 ...
	 */
	protected MapDataSet mergeDataSets(List<MapDataSet> dataSets, VmmcMergingDataSetDefinition dataSetDefinition, EvaluationContext context) {
		...
		if (VmmcMergingDataSetDefinition.MergeOrder.NAME.equals(dataSetDefinition.getMergeOrder())) {
		...
		else if (VmmcMergingDataSetDefinition.MergeOrder.LABEL.equals(dataSetDefinition.getMergeOrder())) {
			Collections.sort(columns, new Comparator<DataSetColumn>() {
				@Override
				public int compare(DataSetColumn column1, DataSetColumn column2) {
